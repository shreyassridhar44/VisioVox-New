...
Copy the checklist from doc 28 §W3 when starting this phase. Tick an item here only once its
verification command has been run and passed — not when the code looks right.
